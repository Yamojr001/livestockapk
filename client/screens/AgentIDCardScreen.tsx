...
export default function AgentIDCardScreen() {
  ...
  const loadSubmissions = async () => {
    ...
    const mySubmissions = data.filter((s) => s.created_by === user?.email);
  ...
  return (
    ...
    >
      <ThemedText style={styles.title}>Farmer ID Cards</ThemedText>
      <ThemedText style={[styles.subtitle, { color: theme.textSecondary }]}>
        Generate ID cards for your registered farmers
      </ThemedText>
